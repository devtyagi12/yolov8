...
| Data | YOLO-format `YOLODataset`, letterbox + HSV/flip augmentation, collate function, `DataLoader` builder. |
...
- Mosaic / mixup / copy-paste augmentations are not implemented (HSV + horizontal
  flip + letterbox are).
